"""Tests for the Financial Conglomerates SCR Portfolio Risk Level data transformation schema."""
...
def test_financial_conglomerates_scr_portfolio_risk_level_schema_structure():
    """Test that the Financial Conglomerates SCR Portfolio Risk Level schema
