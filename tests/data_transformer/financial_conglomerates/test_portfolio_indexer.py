"""Tests for Financial Conglomerates Portfolio Indexer data transformation schema."""
...
def test_financial_conglomerates_portfolio_indexer_schema_structure():
    """Deve ter os nomes das colunas e tipos corretos definidos."""
    schema = FinancialConglomeratePortfolioIndexerSchema()
...
def test_financial_conglomerates_portfolio_indexer_transform_integration(
    mocker, mock_financial_conglomerates_portfolio_indexer_csv_data, transformer_factory, mock_dataframe_from_csv
):
    """Should transform Financial Conglomerates Portfolio Indexer data correctly."""
