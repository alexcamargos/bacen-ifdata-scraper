"""Tests for Individual Institutions Assets data transformation schema."""
...
def test_individual_institutions_assets_schema_structure():
    """Test that the Individual Institutions Assets schema has correct column names and transformation types."""

    schema = IndividualInstitutionAssetsSchema()
...
def test_individual_institutions_assets_transform_integration(
    mocker, mock_individual_institutions_assets_csv_data, transformer_factory, mock_dataframe_from_csv
):
    """Should transform Individual Institutions Assets data correctly."""

    # Create mock DataFrame using the shared helper
    schema = IndividualInstitutionAssetsSchema()
    mock_df = mock_dataframe_from_csv(mock_individual_institutions_assets_csv_data, schema)
