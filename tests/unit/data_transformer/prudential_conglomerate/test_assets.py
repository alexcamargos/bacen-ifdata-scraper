"""Tests for the Prudential Conglomerate Assets data transformation schema."""
...
def test_prudential_conglomerate_assets_schema_structure():
    """Test that the Prudential Conglomerate Assets schema has correct column names and transformation types."""
...
def test_prudential_conglomerate_assets_transform_integration(
    mocker, mock_prudential_conglomerate_assets_csv_data, transformer_factory, mock_dataframe_from_csv
):
    """Should transform Prudential Conglomerate Assets data correctly."""

    # Create mock DataFrame using the shared helper
    schema = PrudentialConglomeratesAssetsSchema()
    mock_df = mock_dataframe_from_csv(mock_prudential_conglomerate_assets_csv_data, schema)
