"""Tests for Prudential Conglomerates Portfolio Legal Person Economic Activity data transformation schema."""
...
def test_prudential_conglomerates_portfolio_legal_person_economic_activity_schema_structure():
    """Test that the Prudential Conglomerates Portfolio Legal Person Economic Activity schema has
    correct column names and transformation types.
    """

    schema = PrudentialConglomeratePortfolioLegalPersonEconomicActivitySchema()
...
def test_prudential_conglomerates_portfolio_legal_person_economic_activity_transform_integration(
    mocker,
    mock_prudential_conglomerate_portfolio_legal_person_economic_activity_csv_data,
    transformer_factory,
    mock_dataframe_from_csv,
):
    """Should transform Prudential Conglomerates Portfolio Legal Person Economic Activity data correctly."""

    # Create mock DataFrame using the shared helper
    schema = PrudentialConglomeratePortfolioLegalPersonEconomicActivitySchema()
    mock_df = mock_dataframe_from_csv(
        mock_prudential_conglomerate_portfolio_legal_person_economic_activity_csv_data, schema
    )
