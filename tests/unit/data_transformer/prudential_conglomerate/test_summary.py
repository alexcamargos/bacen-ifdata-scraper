"""Tests for Prudential Conglomerate data transformation schema."""
...
def test_prudential_conglomerate_summary_schema_structure():
    """Test that the Prudential Conglomerate Summary schema has correct column names and transformation types."""

    schema = PrudentialConglomerateSummarySchema()
    ...
    expected_structure = {
        ...
        'patrimonio_de_referencia': TransformationType.NUMERIC,
        'indice_de_basileia': TransformationType.PERCENTAGE,
        'indice_de_imobilizacao': TransformationType.PERCENTAGE,
...
def test_prudential_conglomerate_transform_integration(
    mocker, mock_prudential_conglomerate_csv_data, transformer_factory, mock_dataframe_from_csv
):
    """Should transform Prudential Conglomerate data correctly."""

    # Create mock DataFrame using the shared helper
    schema = PrudentialConglomerateSummarySchema()
    mock_df = mock_dataframe_from_csv(mock_prudential_conglomerate_csv_data, schema)
