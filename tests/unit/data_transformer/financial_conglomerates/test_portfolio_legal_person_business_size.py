"""Tests for Financial Conglomerates Portfolio Legal Person Business Size data transformation schema."""
...
def test_financial_conglomerates_portfolio_legal_person_business_size_schema_structure():
    """Deve ter os nomes das colunas e tipos corretos definidos."""
    schema = FinancialConglomeratePortfolioLegalPersonBusinessSizeSchema()
...
def test_financial_conglomerates_portfolio_legal_person_business_size_transform_integration(
    mocker,
    mock_financial_conglomerates_portfolio_legal_person_business_size_csv_data,
    transformer_factory,
    mock_dataframe_from_csv,
):
    """Should transform Financial Conglomerates Portfolio Legal Person Business Size data correctly."""
