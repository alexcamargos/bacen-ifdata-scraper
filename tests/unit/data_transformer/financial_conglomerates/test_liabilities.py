"""Tests for Financial Conglomerates Liabilities data transformation schema."""
...
def test_financial_conglomerates_liabilities_schema_structure():
...
def test_financial_conglomerates_liabilities_transform_integration(
    mocker, mock_financial_conglomerates_liabilities_csv_data, transformer_factory, mock_dataframe_from_csv
):
    """Should transform Financial Conglomerates Liabilities data correctly."""

    # Create mock DataFrame using the shared helper
    schema = FinancialConglomerateLiabilitiesSchema()
    mock_df = mock_dataframe_from_csv(mock_financial_conglomerates_liabilities_csv_data, schema)
