"""Tests for Financial Conglomerates Portfolio Number Clients Operations data transformation schema."""
...
def test_financial_conglomerates_portfolio_number_clients_operations_schema_structure():
    """Deve ter os nomes das colunas e tipos corretos definidos."""
    schema = FinancialConglomeratePortfolioNumberClientsOperationsSchema()
...
def test_financial_conglomerates_portfolio_number_clients_operations_transform_integration(
    mocker,
    mock_financial_conglomerates_portfolio_number_clients_operations_csv_data,
    transformer_factory,
    mock_dataframe_from_csv,
):
    """Should transform Financial Conglomerates Portfolio Number Clients Operations data correctly."""
