"""Tests for Financial Conglomerates Portfolio Risk Level data transformation schema."""
...
def test_financial_conglomerates_portfolio_risk_level_schema_structure():
    """Deve ter os nomes das colunas e tipos corretos definidos."""
    schema = FinancialConglomeratePortfolioRiskLevelSchema()
...
def test_financial_conglomerates_portfolio_risk_level_transform_integration(
    mocker, mock_financial_conglomerates_portfolio_risk_level_csv_data, transformer_factory, mock_dataframe_from_csv
):
    """Should transform Financial Conglomerates Portfolio Risk Level data correctly."""
