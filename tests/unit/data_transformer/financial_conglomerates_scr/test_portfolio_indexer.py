"""Tests for the Financial Conglomerates SCR Portfolio Indexer data transformation schema."""
...
def test_financial_conglomerates_scr_portfolio_indexer_schema_structure():
    """Test that the Financial Conglomerates SCR Portfolio Indexer schema
