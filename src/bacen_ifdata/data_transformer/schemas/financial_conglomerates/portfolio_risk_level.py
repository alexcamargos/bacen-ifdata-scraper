...
class FinancialConglomeratePortfolioRiskLevelSchema(BaseSchema):
    ...
    SCHEMA_DEFINITION: Final[dict[str, dict[str, Any]]] = {
        ...
        'aa': {
            'description': 'Volume das operações de crédito classificadas no nível AA.',
            'type': 'numeric',
            'raw_csv_header': 'AA',
        },
        'a': {
            'description': 'Volume das operações de crédito classificadas no nível A.',
            'type': 'numeric',
            'raw_csv_header': 'A',
        },
        'b': {
            'description': 'Volume das operações de crédito classificadas no nível B.',
            'type': 'numeric',
            'raw_csv_header': 'B',
        },
        'c': {
            'description': 'Volume das operações de crédito classificadas no nível C.',
            'type': 'numeric',
            'raw_csv_header': 'C',
        },
        'd': {
            'description': 'Volume das operações de crédito classificadas no nível D.',
            'type': 'numeric',
            'raw_csv_header': 'D',
        },
        'e': {
            'description': 'Volume das operações de crédito classificadas no nível E.',
            'type': 'numeric',
            'raw_csv_header': 'E',
        },
        'f': {
            'description': 'Volume das operações de crédito classificadas no nível F.',
            'type': 'numeric',
            'raw_csv_header': 'F',
        },
        'g': {
            'description': 'Volume das operações de crédito classificadas no nível G.',
            'type': 'numeric',
            'raw_csv_header': 'G',
        },
        'h': {
            'description': 'Volume das operações de crédito classificadas no nível H.',
            'type': 'numeric',
            'raw_csv_header': 'H',
        },
        'total_exterior': {
