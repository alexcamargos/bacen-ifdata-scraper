...
#
#  ------------------------------------------------------------------------------
#  Name: portfolio_geographic_region.py
#  Version: 0.0.1
...
class FinancialConglomerateSCRPortfolioGeographicRegionSchema(BaseSchema):
    """
    Define e categoriza os nomes das colunas para os relatórios de
    Carteira de Crédito Ativa por Região Geográfica de
    ...
    SCHEMA_DEFINITION: Final[dict[str, dict[str, Any]]] = {
        ...
        'regiao_nao_informada': {
            'description': (
                'Volume das operações de crédito para tomadores com endereço no exterior, '
