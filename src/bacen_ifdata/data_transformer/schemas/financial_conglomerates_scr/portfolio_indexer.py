...
class FinancialConglomerateSCRPortfolioIndexerSchema(BaseSchema):
    """
    Define e categoriza os nomes das colunas para os relatórios de
    Carteira de Crédito Ativa por Indexador de
    ...
    SCHEMA_DEFINITION: Final[dict[str, dict[str, Any]]] = {
        ...
        'outros_indices_de_preco': {
            ...
            'type': 'numeric',
            'raw_csv_header': 'Outros Índices de Preço',
        },
        'outros_indexadores': {
            'description': 'Volume das operações de crédito com outros indexadores.',
            'type': 'numeric',
            'raw_csv_header': 'Outros Indexadores',
        },
        'total_nao_individualizado': {
            ...
            'type': 'numeric',
            'raw_csv_header': 'Total não Individualizado',
        },
        'total_exterior': {
