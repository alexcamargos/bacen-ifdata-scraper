...
class FinancialConglomerateSCRPortfolioRiskLevelSchema(BaseSchema):
    """
    Define e categoriza os nomes das colunas para os relatórios de
    Carteira de Crédito Ativa por Nível de Risco de
    ...
    SCHEMA_DEFINITION: Final[dict[str, dict[str, Any]]] = {
        ...
        'total_geral': {
            'description': (
                'Volume total de crédito disponibilizado por instituições financeiras, '
        ...
        'aa': {
            'description': 'Volume das operações classificadas no nível AA.',
            'type': 'numeric',
        },
        'a': {
            'description': 'Volume das operações classificadas no nível A.',
            'type': 'numeric',
        },
        'b': {
            'description': 'Volume das operações classificadas no nível B.',
            'type': 'numeric',
        },
        'c': {
            'description': 'Volume das operações classificadas no nível C.',
            'type': 'numeric',
        },
        'd': {
            'description': 'Volume das operações classificadas no nível D.',
            'type': 'numeric',
        },
        'e': {
            'description': 'Volume das operações classificadas no nível E.',
            'type': 'numeric',
        },
        'f': {
            'description': 'Volume das operações classificadas no nível F.',
            'type': 'numeric',
        },
        'g': {
            'description': 'Volume das operações classificadas no nível G.',
            'type': 'numeric',
        },
        'h': {
            'description': 'Volume das operações classificadas no nível H.',
            'type': 'numeric',
        },
        'total_exterior': {
            'description': 'Volume das operações de crédito realizadas no exterior.',
            'type': 'numeric',
        },
    }
