...
class FinancialConglomerateSCRPortfolioLegalPersonEconomicActivitySchema(BaseSchema):
    ...
    SCHEMA_DEFINITION: Final[dict[str, dict[str, Any]]] = {
        ...
        'atividade_imobiliaria_vencido_a_partir_15_dias': {
            'description': 'Atividade Imobiliária - Operações vencidas há, no mínimo, 15 dias.',
            'type': 'numeric',
        },
        'atividade_imobiliaria_a_vencer_ate_90_dias': {
            'description': 'Atividade Imobiliária - Operações a vencer em até 90 dias ou vencidas há, no máximo, 14 dias.',
            'type': 'numeric',
        },
        'atividade_imobiliaria_a_vencer_de_91_ate_360_dias': {
            'description': 'Atividade Imobiliária - Operações a vencer entre 91 a 360 dias.',
            'type': 'numeric',
        },
        'atividade_imobiliaria_a_vencer_de_361_ate_1080_dias': {
            'description': 'Atividade Imobiliária - Operações a vencer entre 361 a 1080 dias.',
            'type': 'numeric',
        },
        'atividade_imobiliaria_a_vencer_de_1081_ate_1800_dias': {
            'description': 'Atividade Imobiliária - Operações a vencer entre 1081 a 1800 dias.',
            'type': 'numeric',
        },
        'atividade_imobiliaria_a_vencer_de_1801_ate_5400_dias': {
            'description': 'Atividade Imobiliária - Operações a vencer entre 1801 a 5400 dias.',
            'type': 'numeric',
        },
        'atividade_imobiliaria_a_vencer_acima_5400_dias': {
            'description': 'Atividade Imobiliária - Operações a vencer acima de 5400 dias.',
            'type': 'numeric',
        },
        'atividade_imobiliaria_total': {
            'description': 'Atividade Imobiliária - Total do grupo.',
            'type': 'numeric',
        },
        # Comércio
        ...
        'producao_e_distribuicao_de_eletricidade_gas_e_agua_vencido_a_partir_15_dias': {
            'description': 'Produção e Distribuição de Eletricidade, Gás e Água - Operações vencidas há, no mínimo, 15 dias.',
            'type': 'numeric',
        },
        'producao_e_distribuicao_de_eletricidade_gas_e_agua_a_vencer_ate_90_dias': {
            'description': 'Produção e Distribuição de Eletricidade, Gás e Água - Operações a vencer em até 90 dias ou vencidas há, no máximo, 14 dias.',
            'type': 'numeric',
        },
        'producao_e_distribuicao_de_eletricidade_gas_e_agua_a_vencer_de_91_ate_360_dias': {
            'description': 'Produção e Distribuição de Eletricidade, Gás e Água - Operações a vencer entre 91 a 360 dias.',
            'type': 'numeric',
        },
        'producao_e_distribuicao_de_eletricidade_gas_e_agua_a_vencer_de_361_ate_1080_dias': {
            'description': 'Produção e Distribuição de Eletricidade, Gás e Água - Operações a vencer entre 361 a 1080 dias.',
            'type': 'numeric',
        },
        'producao_e_distribuicao_de_eletricidade_gas_e_agua_a_vencer_de_1081_ate_1800_dias': {
            'description': 'Produção e Distribuição de Eletricidade, Gás e Água - Operações a vencer entre 1081 a 1800 dias.',
            'type': 'numeric',
        },
        'producao_e_distribuicao_de_eletricidade_gas_e_agua_a_vencer_de_1801_ate_5400_dias': {
            'description': 'Produção e Distribuição de Eletricidade, Gás e Água - Operações a vencer entre 1801 a 5400 dias.',
            'type': 'numeric',
        },
        'producao_e_distribuicao_de_eletricidade_gas_e_agua_a_vencer_acima_5400_dias': {
            'description': 'Produção e Distribuição de Eletricidade, Gás e Água - Operações a vencer acima de 5400 dias.',
            'type': 'numeric',
        },
        'producao_e_distribuicao_de_eletricidade_gas_e_agua_total': {
            'description': 'Produção e Distribuição de Eletricidade, Gás e Água - Total do grupo.',
            'type': 'numeric',
        },
        # Serviços
