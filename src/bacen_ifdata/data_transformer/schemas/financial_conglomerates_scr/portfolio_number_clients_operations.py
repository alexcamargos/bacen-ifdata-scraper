...
#
#  ------------------------------------------------------------------------------
#  Name: portfolio_number_clients_operations.py
#  Version: 0.0.1
...
class FinancialConglomerateSCRPortfolioNumberClientsOperationsSchema(BaseSchema):
    """
    Define e categoriza os nomes das colunas para os relatórios de
    Quantidade de Clientes e de Operações de
    ...
    SCHEMA_DEFINITION: Final[dict[str, dict[str, Any]]] = {
        ...
        'segmento': {
            ...
            'mapping': {
                ...
                '196': 'Conglomeratede Mercado de Capitais',
        ...
        'quantidade_de_clientes_com_operacoes_ativas': {
            'description': (
                ...
                'ou seja, aqueles possuidores de dívidas acima do limite de individualização do SCR. '
        ...
        'quantidade_de_operacoes_ativas': {
            'description': (
                'São contadas todas as operações com carteira ativa informadas ao SCR. Há contratos de crédito '
                'que são reportados de forma desmembrada e aparecem como mais de uma operação no SCR como, '
