...
class PrudentialConglomeratePortfolioRiskLevelSchema(BaseSchema):
    """
    Define e categoriza os nomes das colunas para os relatórios de
    Carteira de Crédito por Nível de Risco de
    ...
    SCHEMA_DEFINITION: Final[dict[str, dict[str, Any]]] = {
        ...
        'aa': {'description': 'Volume das operações de crédito classificadas no nível AA.', 'type': 'numeric'},
        'a': {'description': 'Volume das operações de crédito classificadas no nível A.', 'type': 'numeric'},
        'b': {'description': 'Volume das operações de crédito classificadas no nível B.', 'type': 'numeric'},
        'c': {'description': 'Volume das operações de crédito classificadas no nível C.', 'type': 'numeric'},
        'd': {'description': 'Volume das operações de crédito classificadas no nível D.', 'type': 'numeric'},
        'e': {'description': 'Volume das operações de crédito classificadas no nível E.', 'type': 'numeric'},
        'f': {'description': 'Volume das operações de crédito classificadas no nível F.', 'type': 'numeric'},
        'g': {'description': 'Volume das operações de crédito classificadas no nível G.', 'type': 'numeric'},
        'h': {'description': 'Volume das operações de crédito classificadas no nível H.', 'type': 'numeric'},
        'total_exterior': {
