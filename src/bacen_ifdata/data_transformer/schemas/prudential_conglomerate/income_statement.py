...
class PrudentialConglomerateIncomeStatementSchema(BaseSchema):
    ...
    SCHEMA_DEFINITION: Final[dict[str, dict[str, Any]]] = {
        ...
        'rendas_operacoes_cambio': {'description': 'Rendas de Operações de Câmbio.', 'type': 'numeric'},
        'rendas_aplicacoes_compulsorias': {'description': 'Rendas de Aplicações Compulsórias.', 'type': 'numeric'},
        'receitas_intermediacao_financeira': {
            'description': 'Somatório das receitas de Intermediação Financeira.',
            'type': 'numeric',
        },
        'despesas_captacao': {'description': 'Despesas de Captação.', 'type': 'numeric'},
        ...
        'despesas_operacoes_cambio': {'description': 'Despesas de Operações de Câmbio.', 'type': 'numeric'},
        ...
        'rendas_prestacao_servicos': {'description': 'Rendas de Prestação de Serviços.', 'type': 'numeric'},
        'rendas_tarifas_bancarias': {'description': 'Rendas de Tarifas Bancárias.', 'type': 'numeric'},
        'despesas_pessoal': {'description': 'Despesas de Pessoal.', 'type': 'numeric'},
        'despesas_administrativas': {'description': 'Despesas Administrativas.', 'type': 'numeric'},
        'despesas_tributarias': {'description': 'Despesas Tributárias.', 'type': 'numeric'},
        'resultado_participacoes': {'description': 'Resultado de Participações.', 'type': 'numeric'},
        'outras_receitas_operacionais': {'description': 'Outras Receitas Operacionais.', 'type': 'numeric'},
        'outras_despesas_operacionais': {'description': 'Outras Despesas Operacionais.', 'type': 'numeric'},
        ...
        'resultado_nao_operacional': {'description': 'Resultado Não Operacional.', 'type': 'numeric'},
        ...
        'participacao_lucros': {'description': 'Participação nos Lucros.', 'type': 'numeric'},
        'lucro_liquido': {
            'description': (
